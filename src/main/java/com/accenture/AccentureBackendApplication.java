...
public class AccentureBackendApplication {

    public static void main(String[] args) {
        SpringApplication.run(AccentureBackendApplication.class, args);
    }

    /*
    @Bean
    CommandLineRunner init(UserRepository clientRepository) {
        return args -> {
